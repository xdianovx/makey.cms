...
.tag {
  @apply border rounded-md px-3 pt-[7px] pb-[8px] inline-block leading-[100%];
}

.red {
  @apply border-[#FBB1C4] text-[#D50B3E] bg-[#FEF0F4];
}

.green {
  @apply border-[#B2EECC] text-[#17663A] bg-[#EEFBF4];
}
.yellow {
  @apply border-[#FFDA85] text-[#8A6100] bg-[#FFF9EB];
}
</style>
